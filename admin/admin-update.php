    ...
    <div class="admin-content">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <div class="am-form-group">
          <input type="hidden" name="older_id" value="<?php echo $older_id;?>">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="date" name="user-birthday" class="am-u-sm-3 am-form-label" value="<?php echo $row['birthday'];?>">
            </div>
          </div>
          ...
          <div class="am-form-group">
            <label for="user-hobit" class="am-u-sm-3 am-form-label">兴趣爱好 / Hobby</label>
            <div class="am-u-sm-9">
              <input type="text" name="user-hobit" value="<?php echo $row['hobit'];?>">
            </div>
          </div>
          ...
          <div class="am-form-group">
            <label for="user-disease" class="am-u-sm-3 am-form-label">病史 / Disease</label>
            <div class="am-u-sm-9">
              <input type="text" name="user-disease" value="<?php echo $row['illhistory'];?>">
            </div>
          </div>
